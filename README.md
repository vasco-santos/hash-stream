...
This repository provides a set of libraries and tools that allow you to build and run a trustless HTTP server for content-addressable data. These building blocks are modular and designed in a plug-and-play fashion, enabling you to use just a subset of them to create a custom server. Going through the [Blueprint](https://vasco-santos.github.io/hash-stream/intro/blueprint) document is a great way to better understand Hashstream.

Documentation can be seen at [https://vasco-santos.github.io/hash-stream](https://vasco-santos.github.io/hash-stream):

- [Deployment Guide](https://vasco-santos.github.io/hash-stream/guides/deployment)
- [Specifications](https://vasco-santos.github.io/hash-stream/specs) - for those interested in implementing building blocks differently
