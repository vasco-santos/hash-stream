# Verifiable Reader Specification
...
This document describes the Verifiable Reader, a system responsible for enabling efficiently retrieving and verifying cryptographically verifiable data.
...
- **Pluggable storage backends**: Supports multiple storage options (e.g., filesystem, cloud storage).

## Interfaces

### Verifiable Reader Interface

```ts
import { MultihashDigest } from 'multiformats'

interface VerifiableReader {
  ...
  stream(targetMultihash: MultihashDigest): AsyncIterable<VerifiableBlob>
}
...
The **Verifiable Reader**, **Index**, and **Pack Reader** work together to enable efficient and structured data retrieval:
...
2. **Verifiable Reader Fetches Bytes**

   - The `VerifiableReader` serves as the primary interface for clients.
