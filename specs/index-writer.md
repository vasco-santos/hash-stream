...
This writer spec complements the [Index spec](./index.md) by describing index creation and persistence. Reading and Writing are not required to be asymmetrical, as soon as the Store knows how to deal with the persisted data format.
