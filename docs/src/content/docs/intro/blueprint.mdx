...
![image](../../../assets/diagrams/hash-stream-0-request.svg)
...
![image](../../../assets/diagrams/hash-stream-3-streamer.svg)
...
![image](../../../assets/diagrams/hash-stream-simple.svg)
...
![image](../../../assets/diagrams/hash-stream-1-index.svg)
...
![image](../../../assets/diagrams/hash-stream-2-read-blobs.svg)
...
![image](../../../assets/diagrams/hash-stream.svg)
...
![image](../../../assets/diagrams/streamer-architecture-horizontal.svg)
...
- **Raw Data**
  - ✅ Use indexing pipeline to generate indexes that point directly to raw data at rest without data transformation. See [Bring Own Storage Guide](/hash-stream/guides/bring-own-storage/), as well as the [AWS Index Pipeline PoC](/hash-stream/pocs/aws-index-pipeline/) and the [Node.js Index Pipeline PoC](/hash-stream/pocs/node.js-index-pipeline/).
