...
- **Raw Data**
  - ✅ Use indexing pipeline to generate indexes that point directly to raw data at rest without data transformation. See [Bring Own Storage Guide](/hash-stream/guides/bring-own-storage/) and the [Index Pipeline PoC](/hash-stream/pocs/index-pipeline/).
